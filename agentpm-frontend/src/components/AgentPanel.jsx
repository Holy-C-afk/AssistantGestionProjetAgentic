...
export default function AgentPanel({ projectId }) {
  ...
  return (
    <>
      ...
      {/* ── Panel ───────────────────────────────────────────── */}
      <div className={`fixed bottom-24 right-6 z-50 w-96 bg-white rounded-2xl shadow-2xl border border-gray-200 flex flex-col overflow-hidden transition-all duration-300
        ...
        {tab === 'recherche' && (
          <div className="flex-1 flex flex-col p-4 overflow-hidden">
            <p className="text-xs text-gray-500 mb-3">
              Recherche sémantique parmi les tâches du projet courant.
            </p>
            ...
            {!projectId && (
              <div className="flex-1 flex items-center justify-center">
                <p className="text-sm text-gray-400 text-center">
                  🔒 Ouvrez un projet pour activer<br />la recherche sémantique.
                </p>
              </div>
            )}
            ...
            {projectId && searchResults === null && !searching && (
              <div className="flex-1 flex items-center justify-center">
                <p className="text-sm text-gray-400 text-center">
                  Entrez une description de tâche<br />pour trouver des tâches similaires.
                </p>
              </div>
            )}
              ...
              <div className="flex-1 overflow-y-auto space-y-2">
                {searchResults.length === 0 ? (
                  <p className="text-sm text-gray-400 text-center pt-8">
                    Aucune tâche similaire trouvée.
                  </p>
                ) : (
                  <>
